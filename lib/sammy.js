...
(function($, window) {
  ...
  Sammy.EventContext.prototype = $.extend({}, Sammy.Object.prototype, {
    ...
    // starts a new RenderContext and calls 'then()' with the supplied callback
    // useful for prepopulating subsequent calls down the chain
    start: function(callback){
        return new Sammy.RenderContext(this).then(callback);
    },
